...
import Cathedral from '../assets/images/optimized/cathedral_person2.webp';
import Eve from '../assets/images/poems/optimized/eve2.webp';
    ...
    <StyledAbout>
        <Card width="100%" background="transparent" boxShadow="unset" padding="unset" margin="unset">
            <Card width="45em" margin="25px auto" height="fit-content">
                ...
                <img src={Cathedral} alt="Man in a cathedral" width="100%" />
                <p>
        ...
        <Card width="100%" background="transparent" boxShadow="unset" padding="unset" margin="unset">
            <Card width="45em" margin="25px auto" height="fit-content">
                ...
                <p>
                    Wenn Kunst fremdgeht, dann lass sie in Nietzsches Abgrund stolpern, damit sie von denselben Monstern verzehrt wird, die sie hervorgerufen hat!
                ...
                <img src={Eve} alt="Eve's realization after eating from the forbidden fruit" width="100%" />
                <p>
                ...
                <p>
                    Manche Kunst muss man opfern, um Frieden mit Gott zu haben, weil ihr Charakter dem Wesen Gottes nicht entspricht. Sich in solcher Kunst zu verlieren, verfehlt das Ziel, eine positive Kraft für die Gesellschaft zu sein.
